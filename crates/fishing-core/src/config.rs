...
pub struct BotConfig {
    pub energy_monitoring_enabled: bool,
    pub energy_failure_policy: EnergyFailurePolicy,
...
impl Default for BotConfig {
    fn default() -> Self {
        Self {
            ...
            energy_failure_policy: EnergyFailurePolicy::Continue,
...
impl BotConfig {
    /// Feeding always needs Energy observations, independent of the optional display setting.
    pub fn monitors_energy(&self) -> bool {
        self.energy_monitoring_enabled || self.auto_feed_enabled
    }
...
pub fn macbook_profile() -> BotConfig {
    serde_json::from_str(include_str!(
        "../../../configs/macbook-pro-14-3024x1964.json"
    ))
